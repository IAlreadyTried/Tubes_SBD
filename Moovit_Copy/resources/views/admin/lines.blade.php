              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <h2 style="background-color: rgb(255, 46, 88)">Masih Pending..</h2>
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Username</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-outline-danger"><i class="mdi mdi-delete mdi-18px"></i></button></td>
                      </tr>
                      <tr>
                        <td>2</td>
                        <td>Messsy</td>
                        <td>Messsy</td>
                        <td>messy@mail.com</td>
                        <td><button type="button" class="btn btn-outline-danger"><i class="mdi mdi-delete mdi-18px"></i></button></td>
                      </tr>
                    </tbody>
                  </table>
